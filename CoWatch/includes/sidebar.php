        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">CoWatch</div>
            </a>
...
<?php if($_SESSION['aid']):?>
 ...
 <a class="collapse-item" href="all-test.php">All Tests</a>
   ...
   <li class="nav-item">
    ...
    <hr class="sidebar-divider my-0">
    <li class="nav-item">
                <a class="nav-link" href="admin-vac-req.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Vaccine Requests</span></a>
            </li>
...
<!-- Vaccination Part -->
        <hr class="sidebar-divider">
            ...
            <li class="nav-item">
                <a class="nav-link" href="new-vac.php">
...
<!-- <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="new-vac.php">New User</a>
                        <a class="collapse-item" href="registered-user-testing.php">Already Registered User</a>
                    </div>
                </div>
            </li> -->
