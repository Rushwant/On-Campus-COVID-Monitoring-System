...
<head>
    ...
    <title>CoWatch | Admin Login</title>
...
<body class="bg-gradient-success">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff; font-weight:bold">CoWatch- Admin Login</h3>
...
<form name="login" method="post">
                        ...
                        <input type="submit" name="login" class="btn btn-dark btn-user btn-block" value="login">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small text-dark" href="password-recovery.php" style="font-weight:bold">Forgot Password?</a>

                                    </div>

                                         <div class="text-center">
                                        <a class="small text-dark" href="index.php" style="font-weight:bold;"><i class="fa fa-home" aria-hidden="true"></i> Home Page</a>
                                    </div>
