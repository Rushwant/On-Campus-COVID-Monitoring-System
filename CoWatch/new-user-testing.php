...
$query="insert into tblpatients(FullName,MobileNumber,DateOfBirth,GovtIssuedId,GovtIssuedIdNo,FullAddress,State,snuid,hostel,OrderNumber) values('$fname','$mnumber','$dob','$govtid','$govtidnumber','$address','$state','$snuid','$hostel','$orderno');";
...
<head>
    ...
    <title>CoWatch | New User Testing</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid19 Testing- Book a Slot</h1>
