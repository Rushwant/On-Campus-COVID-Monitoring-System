        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Already Registered Users</h1>
...
<div class="form-group">
                                 <input type="submit" class="btn btn-success btn-user btn-block" name="search" value="Search">                           
                             </div>
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="state" name="state" value="<?php echo $result['State']; ?>" readonly="true">
                                        ...
                                        <div class="form-group">
                                              <label>SNU ID</label>
                                            <textarea class="form-control" id="snuid" name="snuid" readonly="true"><?php echo $result['snuid']; ?></textarea>
                                        </div>

                                        <div class="form-group">
                                              <label>Hostel</label>
                                            <textarea class="form-control" id="hostel" name="hostel" readonly="true"><?php echo $result['hostel']; ?></textarea>
                                        </div>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-danger">Testing Information</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
