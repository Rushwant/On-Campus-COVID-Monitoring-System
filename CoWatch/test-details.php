...
$query2=mysqli_query($con,"update tbltestrecord set ReportStatus='$status',FinalReport='$newreportfile',res='$res',ReportUploadTime='$uploadtime' where OrderNumber='$orderid'");
$query3=mysqli_query($con,"update tblpatients set res='$res' where OrderNumber='$orderid'");
...
<head>
    ...
    <title>CoWatch | Test Details</title>
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-danger">Test Information</h6>
                                </div>
                                <div class="card-body">
...
<?php if($row['AssignedtoEmpId']==''): 
    ?>
      ...
      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#assignto">Assign To</button>
            </div>                                        
<?php else: 
...
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#takeaction">Take Action</button>
<?php 
endif;
endif;?>    
                                </div>
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-danger" align="center">Test  Tracking History</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<form method="post">
        ...
        <?php } ?>
            ...
            <p>
     <input type="submit" class="btn btn-success btn-user btn-block" name="submit" id="submit">   </p> 
...
endwhile;
  ?>
       ...
       <p id='res'> Result <br>
       <input type="radio" id="pos" name="res" value="1"> <label for="pos">Positive</label><br> 
       <input type="radio" id="neg" name="res" value="0"> <label for="neg">Negative</label> 
      </p>
       <p>
<textarea name="remark" class="form-control" required="false" placeholder="Remark (Max 500 Characters)" maxlength="500" rows="5"></textarea>  </p> 
  <p>
     <input type="submit" class="btn btn-success btn-user btn-block" name="takeaction" id="submit">   </p> 
...
<script type="text/javascript">
  ...
  $('#res').show();
  // jQuery("#result").prop('required',true);
  }
  else{
  $('#reportfile').hide();
  }
